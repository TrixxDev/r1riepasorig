...
class TCPDF_FONTS extends Model {
  ...
  public static function _getfontpath() {
    if (!defined('K_PATH_FONTS') AND is_dir($fdir = realpath(dirname(__DIR__, 2).'/font'))) {
      if (substr($fdir, -1) != '/') {
        $fdir .= '/';
      }
...
// ====================================================================================================================
  ...
  public static function UTF8ArrayToUniArray($ta, $isunicode=true) {
    if ($isunicode) {
      return array_map(array(Self::class, 'unichrUnicode'), $ta);
    }
    return array_map(array(Self::class, 'unichrASCII'), $ta);
  }
  ...
  public static function UTF8StringToArray($str, $isunicode, &$currentfont) {
    if ($isunicode) {
      ...
      $carr = array_map(array(Self::class, 'uniord'), $chars);
    } else {
      $chars = str_split($str);
