...
use App\Models\TCPDF_STATIC;
use App\Models\TCPDF_FONTS;
use App\Models\TCPDF_FONT_DATA;
...
class Pdf extends Model {
  ...
  public function __construct($orientation='P', $unit='mm', $format='A4', $unicode=true, $encoding='UTF-8', $diskcache=false, $pdfa=false) {
    ...
    $this->InFooter = false;
    $this->lasth = 0;
    $this->FontFamily = defined('PDF_FONT_NAME_MAIN')?PDF_FONT_NAME_MAIN:'freeserif';
    $this->FontStyle = '';
    $this->FontSizePt = 12;
