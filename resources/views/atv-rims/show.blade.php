...
@php
  $productTitle = $currRim->fullTitle ?? $currRim->fullName ?? 'Kvadraciklu diski';
...
@section('meta_description', $productDescription ?: 'Kvadraciklu lietie diski — R1 Riepu Serviss katalogs.')

@section('content')

  <div class="container">
    <p class="mb-3 small">
      <a href="{{ route('kvadraciklu-diski') }}">&larr; Atpakaļ uz kvadraciklu diskiem</a>
    </p>
    <div class="row">
  ...
  <script src="{{ asset('js/rimProductPageCart.js?v='.(int) microtime(true)) }}"></script>
