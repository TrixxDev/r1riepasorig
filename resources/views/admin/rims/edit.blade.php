        ...
        <form class="form-horizontal" action="{{ route('admin.rims.update', $rim->rim_id) }}" method="post" enctype="multipart/form-data">
          <div class="card-header">{{ 'Labot info - ' . $rim->fullTitle . ' | ' . $rim->d1 . '*' . $rim->d3 }}
            <div style="float: right; position: relative; top: -7px;">
              ...
              <a class="btn btn-md btn-info" href="{{ route('admin.rims.search', $rim->make_id) }}"> Atpakaļ</a>
            </div>
          </div>
          <div class="card-body">
            @csrf
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9">
                <input class="form-control" id="dc" type="text" @if ($rim->dc) value="{{ $rim->dc }}" @endif name="dc" placeholder="Centrs">
              </div>
            </div>
            <div class="form-group row">
