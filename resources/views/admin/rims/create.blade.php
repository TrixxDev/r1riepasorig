...
@section('content')
  ...
  <div class="container-fluid">
    <div class="fade-in">
      ...
      @endif
      <div class="card">
        <form class="form-horizontal" action="{{ route('admin.rims.store', $tread->make_id) }}" method="post" enctype="multipart/form-data">
          <div class="card-header">Pievienot disku - {{ $brand->title . ' ' . $tread->title }}
            <div style="float: right; position: relative; top: -7px;">
              ...
              <a class="btn btn-md btn-info" href="{{ route('admin.rims.search', $tread->make_id) }}"> Atpakaļ</a>
            </div>
          </div>
          <div class="card-body">
            @csrf
            ...
            <div class="form-group row">
              <label class="col-md-3 col-form-label" for="dc">Centrs</label>
              <div class="col-md-9">
                <input class="form-control" id="dc" type="text" name="dc" placeholder="Centrs">
              </div>
            </div>
            <div class="form-group row">
