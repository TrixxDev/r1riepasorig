          ...
          <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
            ...
            <div class="row">
              <div class="col-md-6 preview-image">
                @if (isset($tread))
                  {!! App\Helper\Image::showGrid('studs', $tread->tread_id, 'width: 300px; margin-bottom: 20px;') !!}

                  <form action="{{ route('admin.studs.image', $tread->tread_id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                      <div class="col-md-3">
                    ...
                    <div class="container" style="margin-top: 10px;">
                      ...
                      <div class="tab-content">
                        <div class="tab-pane container fade show active" id="tread">
                          <textarea disabled class="form-control tread-comment-text" name="tread-comment-text" cols="80" rows="13">
                            {!! $tread->t_comment !!}
                          </textarea>
                        </div>
                        <div class="tab-pane container fade" id="brand">
                          <textarea disabled class="form-control brand-comment-text" name="brand-comment-text" cols="80" rows="13">
                            {!! $brand->b_comment !!}
                          </textarea>
                        </div>
                      </div>
            ...
            @if (isset($tread))
              <div class="row justify-content-end tires-header">
                <button class="btn btn-md btn-primary new_tire"><a class="text-white" href="
                  {{ route('admin.studs.create', $tread->tread_id) }}
                ">Pievienot</a></button>
              </div>
            @endif
            <div class="row">
              <div class="col-sm-12">
                <table class="table table-striped table-bordered datatable dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="border-collapse: collapse !important">
                  <thead>
                  <tr role="row">
                    <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Date registered: activate to sort column ascending" style="width: 320.609px;">Pielietojums</th>
                    <th rowspan="1" colspan="1" style="width: 151.953px;">Garums</th>
