...
@section('content')
    ...
    <div class="container-fluid">
        <div class="fade-in">
            <div class="card">
                <form class="form-horizontal" action="{{ route('admin.auto.brands.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-header">Pievienot jaunu auto riepu brendu</div>
                    <div class="card-body">
