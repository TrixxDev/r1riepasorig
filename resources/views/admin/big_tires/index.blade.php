...
@section('content')
    ...
    <div class="container-fluid">
        <div class="fade-in">
            ...
            @endif
            <div class="card">
                <div class="card-header"> Lielās riepas
                    ...
                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group row brand-settings">
                                    ...
                                    <select name="brand" class="form-control col-md-3" data-model="big" id="brand_select">
                        ...
                        <div class="row">
                            <div class="col-md-6 preview-image">
                                @if (isset($tread))
{{--                                  {{ dd($tread) }}--}}
                                  {!! App\Helper\Image::showGrid('big', $tread->tread_id, 'width: 300px; margin-bottom: 20px;') !!}

                                  <form action="{{ route('admin.big.tires.image', $tread->tread_id) }}" method="post" enctype="multipart/form-data">
                                      @csrf
                                      <div class="row">
                                          <div class="col-md-3">
...
{{--                                <textarea disabled class="form-control comment-text-disabled" cols="80" rows="13">{!! $tread->t_comment !!}</textarea>--}}
  ...
  {{--                              </div>--}}
                        ...
                        @if (isset($tread))
                        <form method="post" action="{{ route('admin.big.tires.delete_all', $tread->tread_id) }}">
                        @csrf
                        <div class="row justify-content-end tires-header">
                          ...
                          @endif
                          <a class="text-white btn btn-md btn-primary new_tire" href="{{ route('admin.big.tires.create', $tread->tread_id) }}">Pievienot</a>
                        </div>
                        @endif
                        <div class="row">
                            <div class="col-sm-12">
                                <table class="table table-striped table-bordered datatable dataTable no-footer" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="border-collapse: collapse !important">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Actions: activate to sort column ascending" style="width: 150.391px;">Pielietojums</th>
