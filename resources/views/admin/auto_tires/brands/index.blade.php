...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="fade-in">
            <div class="card">
                <div class="card-header"> Auto riepu brendi
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="dataTables_length" id="DataTables_Table_0_length">
                                    <label>Rādīt
                                        <select name="perPage" onchange="location = '{{ route('admin.auto.brands.search') }}/' + this.value" aria-controls="DataTables_Table_0" class="custom-select custom-select-sm form-control form-control-sm">
                                    ...
                                    @if (Session::get('search'))
                                        <a class="btn btn-md btn-primary" style="margin-left: 100px;" href="{{ route('admin.auto.brands.search') }}">Dzēst filtru</a>
                                    @endif
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6" style="display: inline-flex; place-content: flex-end;">
                                <form method="post" action="{{ route('admin.auto.brands.search') }}">
                                    @csrf
...
{{--                                            <td>{{ $tire->d1 }}</td>--}}
                                            <td style="width: 8.3%!important;">
                                                ...
                                                <a class="btn btn-danger brand_delete" id="{{ $brand->brand_id }}" href="{{ route('admin.auto.brands.delete', $brand->brand_id) }}">
                                                    <svg class="c-icon">
