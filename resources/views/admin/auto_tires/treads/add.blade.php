...
@section('content')
    ...
    <div class="container-fluid">
        <div class="fade-in">
            <div class="card">
                <form class="form-horizontal" action="{{ route('admin.auto.treads.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select name="tread_season" class="form-control" id="season-input">
                                    <option value="1">Vasara</option>
                                    <option value="2">Ziema</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
