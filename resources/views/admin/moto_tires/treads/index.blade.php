...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="fade-in">
            <div class="card">
                <div class="card-header"> Moto riepu modeļi
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6">
                                <div class="dataTables_length" id="DataTables_Table_0_length">
                                    <label>Rādīt
                                        <select name="perPage" onchange="location = '{{ route('admin.moto.treads.search') }}/' + this.value" aria-controls="DataTables_Table_0" class="custom-select custom-select-sm form-control form-control-sm">
                                    ...
                                    @if (Session::get('search'))
                                        <a class="btn btn-md btn-primary" style="margin-left: 100px;" href="{{ route('admin.moto.treads.search') }}">Dzēst filtru</a>
                                    @endif
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-6" style="display: inline-flex; place-content: flex-end;">
                                <form method="post" action="{{ route('admin.moto.treads.search') }}">
                                    @csrf
                                ...
                                <a style="float: right; height: 28.38px; line-height: 13px; margin-left: 10px;" class="btn btn-md btn-primary" href="{{ route('admin.moto.treads.add') }}"> Pievienot modeli</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
